...
public class UserThird implements ActionListener, Runnable {
    ...
    UserThird() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/tour.jpg"));
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("icons/vd.png"));
        ...
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("icons/ph.png"));
        ...
        JLabel name = new JLabel("Tour Group");
        name.setBounds(110, 15, 100, 18);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SAN_SERIF", Font.BOLD, 17));
        p1.add(name);
        
        JLabel status = new JLabel("Amir,Kaifi,Anamul,Nahian,Razin");
